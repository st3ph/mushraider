<div class="tac">
    ...
    <?php $userHtml = '<i class="fa fa-user fa-2x"></i>';?>
    ...
    <?php $charsHtml = '<i class="fa fa-shield fa-2x"></i>';?>
    ...
    <?php $dungeonsHtml = '<i class="fa fa-home fa-2x"></i>';?>
    ...
    <?php $gamesHtml = '<i class="fa fa-gamepad fa-2x"></i>';?>
    ...
    <?php $eventsHtml = '<i class="fa fa-calendar fa-2x"></i>';?>
