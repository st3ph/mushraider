            ...
            <div class="well well-white">
                ...
                <div class="form-group">
                    <div class="input text" id="apiPrivateKey">
                        ...
                        <span class="refresh fa fa-refresh tt" title="<?php echo __('Generate a new private key');?>"></span>
                ...
                <div id="apiModules" <?php echo isset($this->data['Setting']['enabled']) && $this->data['Setting']['enabled']?'':'class="hide"';?>>
                    ...
                    <p class="label label-info">
                        <i class="fa fa-info-circle"></i> <?php echo __('MushRaider integration (or bridge) let your users connect to MushRaider using the login and password of your current website/forum instead of having 2 differents accounts.');?><br />
                    ...
                    <p class="label label-important">
                        <i class="fa fa-exclamation-circle"></i> <?php echo __('Before enabling bridge make sure your site/forum is set up correctly to bridge with MushRaider by installing and setting up the corresponding plugin.');?>
                    </p>
                    ...
                    <div class="form-group">
                        <?php $after = '<span class="hint fa fa-question-circle tt" title="'.__('Adress provided in the settings of your site/forum MushRaider plugin').'"></span>'?>
