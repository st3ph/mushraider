<header>
    <h1><i class="fa fa-clock-o"></i> <?php echo __('Manage absences');?></h1>
</header>
                            ...
                            <tr>
                                ...
                                <td class="span2 text-right buttons">
                                    <?php if($availability['Availability']['start'] >= date('Y-m-d')):?>
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>', '/account/availabilities/edit/'.$availability['Availability']['id'], array('class' => 'btn btn-info btn-mini tt edit', 'title' => __('Edit'), 'data-id' => $availability['Availability']['id'], 'escape' => false));?>
                                    <?php endif;?>
                                    <?php echo $this->Html->link('<i class="fa fa-trash"></i>', '/account/availabilities/delete/'.$availability['Availability']['id'], array('class' => 'btn btn-danger btn-mini tt confirm', 'title' => __('Delete'), 'data-confirm' => __('Are you sure you want to delete this absence ?'), 'escape' => false))?>
                                </td>
                            </tr>
                        <?php endforeach;?>
                    <?php endif;?> 
