<table width="550" cellspacing="0" cellpadding="0">
    <tr align="left" valign="top">
        <td width="550" valign="top" align="left">
            ...
            <br />
            <p><?php echo __('To give your availability for this event please follow this link');?> : <?php echo $this->Html->link('http://'.$_SERVER['HTTP_HOST'].$this->webroot.'events/view/'.$event['id'], 'http://'.$_SERVER['HTTP_HOST'].$this->webroot.'events/view/'.$event['id'], array('escape' => false));?></p>
            <br />
            <br />
